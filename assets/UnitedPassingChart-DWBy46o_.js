import{t as e}from"./rolldown-runtime-lhHHWwHU.js";import{t}from"./main-BS6onijg.js";var n=e({initUnitedPassing:()=>f}),r={bg:`#0F1117`,surface:`#1A1D24`,border:`#2A2D35`,text1:`#F0F2F6`,text2:`#9BA3B0`,red:`#DA291C`,yellow:`#FBE122`,gold:`#F59E0B`,blue:`#4F8BF9`,green:`#3FB950`},i={paper_bgcolor:`rgba(0,0,0,0)`,plot_bgcolor:`rgba(26,29,36,0.6)`,font:{family:`Inter, system-ui`,color:r.text1,size:12}},a=null,o=`network`,s=`Resto PL`,c=5,l=[`CDM`,`CM`,`CAM`,`RW`,`ST`],u=`xT`,d=`prog`;async function f(){a=await t(`./data/united-passing.json`),p(),w(),m(),T()}function p(){let e=document.getElementById(`passing-view-selector`);e&&(e.innerHTML=`
    <div class="view-tabs">
