import{t as e}from"./rolldown-runtime-lhHHWwHU.js";import{t}from"./main-2avnwFrq.js";var n=e({initManchesterUnited:()=>s}),r={manutd:`#DA291C`,champ:`#3fb950`,accent:`#58a6ff`,warn:`#e3b341`,bad:`#f78166`,bg:`#0d1117`,card:`#161b22`,border:`#30363d`,text:`#e6edf3`,text2:`#8b949e`},i={paper_bgcolor:`rgba(0,0,0,0)`,plot_bgcolor:`rgba(22,27,34,0.6)`,font:{family:`Inter, sans-serif`,color:r.text,size:12},margin:{l:10,r:10,t:45,b:10},xaxis:{gridcolor:`#30363d`,zerolinecolor:`#30363d`},yaxis:{gridcolor:`#30363d`,zerolinecolor:`#30363d`}},a=null,o={seasons:[],managers:[],benchmarkMode:!0,showTrend:!0};async function s(){a=await t(`./data/manutd.json`),o.seasons=a.seasons.map(e=>e.season),o.managers=[...new Set(a.seasons.map(e=>e.manager_clean))],l(),f(),p(),u()}function c(){return a.seasons.filter(e=>o.seasons.includes(e.season)&&o.managers.includes(e.manager_clean))}function l(){let e=document.getElementById(`manutd-filters`);e&&(e.innerHTML=`
